    ...
    <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link active" id="description-tab" data-toggle="tab" href="#description" role="tab"
               aria-controls="description" aria-selected="true">Chỉnh sửa chức vụ</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/chuc-vu/hien-thi-delete" role="tab" onclick="return myFunction7()">Chức vụ đã
                xoá</a>
        </li>
    </ul>
</div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <form:label class="form-label" path="chucVu">Tên chức vụ:</form:label>
                                            <div class="col-sm-9">
                                                <form:input class="form-control" placeholder="" path="chucVu"/>
