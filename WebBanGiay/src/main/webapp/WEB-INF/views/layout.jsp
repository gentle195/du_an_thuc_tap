                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="tables">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item"><a class="nav-link" href="/hang-san-pham/hien-thi">Hãng</a></li>
                            <li class="nav-item"><a class="nav-link" href="/mau-sac/hien-thi">Màu Sắc</a></li>
                            <li class="nav-item"><a class="nav-link" href="/chat-lieu/hien-thi">Chất Liệu Giày</a></li>
                            <li class="nav-item"><a class="nav-link" href="/de/hien-thi">Đế Giày</a></li>
                            <li class="nav-item"><a class="nav-link" href="/anh/hien-thi">Hình Ảnh</a></li>
                            <li class="nav-item"><a class="nav-link" href="/size/hien-thi">Size Giày</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
