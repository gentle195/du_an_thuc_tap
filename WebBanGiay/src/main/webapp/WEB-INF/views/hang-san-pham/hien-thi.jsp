    ...
    <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="description-tab" data-toggle="tab" href="#description" role="tab"
               aria-controls="description" aria-selected="true">Thông tin hãng sản phẩm</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/khach-hang/hien-thi-delete" role="tab" onclick="return myFunction7()">Hãng sản phẩm
                đã xoá</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/hang-san-pham/view-add" role="tab"  onclick="return myFunction6()">Thêm hãng sản phẩm</a>
        </li>
    </ul>
</div>
<div>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <%--            Tìm kiếm               --%>
                        <form action="/hang-san-pham/search-0" method="post">
                            <div class="row">
                                <div class="col-8">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <c:forEach items="${listHSP}" var="hsp" varStatus="stt">
                                    <tr>
                                        <td>${hsp.ma}</td>
                                        <td>${hsp.ten} </td>
                                        <td>${hsp.xuatSu} </td>
                                        <td>${hsp.ngayTao}</td>
                                        <td>${hsp.ngayCapNhat}</td>

                                        <td>
                                            <c:if test="${hsp.tinhTrang==0}">hoạt động</c:if>
                                            <c:if test="${hsp.tinhTrang==1}">ngưng hoạt động</c:if>
                                        </td>

                                        <td colspan="2">
                                            <a class="btn btn-warning btn-icon-text"
                                               href="/hang-san-pham/view-update/${hsp.id}"
                                               onclick="return myFunction2()">
                                                <i class="ti-file btn-icon-prepend"></i>
                                                Update</a>
                                            <a class="btn btn-danger btn-icon-text"
                                               href="/hang-san-pham/update-status/${hsp.id}"
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center pagination-lg">
                            ...
                            <li class="page-item"><a class="page-link"
                                                     href="/hang-san-pham/hien-thi?num=${total-1}">Last</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
