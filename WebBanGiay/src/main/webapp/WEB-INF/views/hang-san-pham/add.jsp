...
<div>
    <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
        <li class="nav-item">
            <a class="nav-link" href="/hang-san-pham/hien-thi" role="tab"  onclick="return myFunction4()">Thông tin hãng sản phẩm</a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" id="description-tab" data-toggle="tab" href="#description" role="tab"
               aria-controls="description" aria-selected="true">Thêm hãng sản phẩm</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/hang-san-pham/hien-thi-delete" role="tab" onclick="return myFunction7()">hãng sản phẩm đã xoá</a>
        </li>
    </ul>
</div>
<div>
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="description" role="tabpanel"
            ...
            <form:form action="/hang-san-pham/add" method="post" modelAttribute="HSP">
                        ...
                        <div class="card-body">
                            ...
                            <form class="form-sample">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <form:label class="form-label" path="ten">Tên HSP:</form:label>
                                            <div class="col-sm-9">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12 form-control">
                                                <form:radiobutton path="tinhTrang" value="0" checked="true"/>Hoat động
