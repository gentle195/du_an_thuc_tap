    ...
    <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="description-tab" data-toggle="tab" href="#description" role="tab"
               aria-controls="description" aria-selected="true">Thông tin khuyến mãi</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/khuyen-mai/hien-thi-delete" role="tab" onclick="return myFunction7()">Khuyến mãi
                đã xoá</a>
        </li>
        <li class="nav-item">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <%--            Tìm kiếm               --%>
                        <form action="/khuyen-mai/search-0" method="post">
                            <div class="row">
                                <div class="col-8">
