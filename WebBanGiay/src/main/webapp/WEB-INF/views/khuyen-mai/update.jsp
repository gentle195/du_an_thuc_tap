    ...
    <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link active" id="description-tab" data-toggle="tab" href="#description" role="tab"
               aria-controls="description" aria-selected="true">Sửa khuyến mãi</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/khuyen-mai/hien-thi-delete" role="tab"  onclick="return myFunction7()">Khuyến mãi đã xoá</a>
        </li>
    </ul>
</div>
<div>
