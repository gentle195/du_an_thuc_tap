...
<div>
    <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
        <li class="nav-item">
            <a class="nav-link" href="/khach-hang/hien-thi" role="tab" onclick="return myFunction4()">Thông tin khách
                hàng </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/khach-hang/view-add" role="tab" onclick="return myFunction6()">Thêm khách
                hàng </a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" id="description-tab" data-toggle="tab" href="#description" role="tab"
               aria-controls="description" aria-selected="true">Khách hàng đã xoá</a>
        </li>
        <a href="/khach-hang/update-all" class="btn btn-outline-danger btn-icon-text"
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <%--            Tìm kiếm               --%>
                        <form action="/khach-hang/search-1" method="post">
                            <div class="row">
                                <div class="col-8">
                            ...
                            <table class="table table-striped">
                                ...
                                <c:forEach items="${listKhachHang}" var="khachHang" varStatus="stt">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/khach-hang/reset-status/${khachHang.id}"
